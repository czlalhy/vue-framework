...
function(e, t) {
	...
	default = o.exports
		...
		default],
			Bt = function(e) {
				...
				Ft.
			default.use(t.locale), Ft.
			default.i18n(t.i18n), Lt.map(function(t) {
					e.component(t.name, t)
				}), e.use(Ve.
			default.directive);
				var i = {};
				i.size = t.size || "", e.prototype.$loading = Ve.
	...
	default = o.exports
		...
		function(e) {
			...
			return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
		}, r = i(1), a = n(r), o = i(26), l = n(o), u = i(5), c = n(u), d = i(8), h = n(d), f = i(106), p = n(f), m = i(66), v = n(m), g = i(31), b = n(g), y = i(27), _ = n(y), x = i(13), C = n(x), w = i(17), k = n(w), S = i(4), M = i(28), $ = i(16), E = i(44), D = n(E), T = i(6), P = i(119), O = n(P), N = {
			medium: 36,
			small: 32,
			mini: 28
		};
	...
	default = {
		...
		default],
			...
			created: function() {
				var e = this;
				this.cachedPlaceHolder = this.currentPlaceholder = this.placeholder, this.multiple && !Array.isArray(this.value) && this.$emit("input", []), !this.multiple && Array.isArray(this.value) && this.$emit("input", ""), this.debouncedOnInputChange = (0, C.
